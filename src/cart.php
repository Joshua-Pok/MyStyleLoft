...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- display cart items -->
        <div id="cart">
            <form id="shoppingCart" action="../src/checkOut.php" method="POST">
                <div id="itemsInCart">
                    <?php
                        $db = new mysqli('localhost', 'root', '', 'myStyleLoft');
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<form action="removeFromCart.php" method="POST" class="removeItemForm">';
                                // echo '<input type="hidden" name="productId[]" value="'.$row['productId'].'">';
                                echo '<button type="submit" id="removeFromCart" onclick="removeFromCart.php"><i class="fa-solid fa-trash"></i></button>';
                                echo '</form>';
                                echo '</div>';
                                echo '</div>';
                            }
