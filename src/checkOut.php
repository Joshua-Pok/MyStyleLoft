                    ...
                    <div class="checkOutProduct">
                        ...
                        <?php
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                echo "<input type='hidden' value='$subtotal' id='subtotalValue' name='subtotals[]'>";
                            }
                        ?>
                    </div>
                ...
                <div id="rightColumn">
                    ...
                    <div class="orderSummary">
                        <div id="bill">
                            ...
                            <div id="total">
                                <p>Total <small>(Including GST)</small></p>
                                <p id="totalPrice">$</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="payment">
                        <div id="paymentDetails">
                            <div class="email">
                                ...
                                <input type="text" id="email" oninput="chkEmail(event)" placeholder="Enter your email here" required>
                                <br> <span id="emailError"></span>
                            </div>

                            <label style="font-weight:bold; padding-bottom:5px;">Card Details</label>
                            <div>
                                <label for="name">Name</label>
                                <input type="text" id="name" oninput="chkName(event)" placeholder="Enter name on the card here" required>
                                <br> <span id="nameError"></span>

                                <label for="cardNo">Card number</label>
                                <input type="text" id="cardNo" oninput="chkCardNo(event)" placeholder="XXXX XXXX XXXX XXXX" required>
                                <br> <span id="cardNoError"></span>
                                
                                <div class="expiry-cvv">
                                    <div>
                                        <label for="expiry">Valid thru</label>
                                        <input type="text" id="expiry" oninput="chkExpiry(event)" placeholder="MM/YY" required>
                                        <br> <span id="cardNoError"></span>
                                    </div>

                                    <div>
                                        <label for="cvv">CVV</label>
                                        <input type="text" id="cvv" oninput="chkCVV(event)" placeholder="XXX" required>
                                        <br> <span id="cvvError"></span>
                                    </div>
                                </div>
                            </div>
                            <!-- card details -->
